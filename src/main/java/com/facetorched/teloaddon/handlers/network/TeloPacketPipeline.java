...
public class TeloPacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket>
{
	...
	public boolean registerPacket (Class<? extends AbstractPacket> clazz)
	{
		...
		{
			TeloLogger.error("Error Registering Packet, Too Big: " + clazz.getName());
			return false;
		}

		if (this.packets.contains(clazz))
		{
			TeloLogger.error("Error Registering Packet, Already Exists: " + clazz.getName());
			return false;
		}

		if (this.isPostInitialised)
		{
			TeloLogger.error("Error Registering Packet, Initialization Already Completed: " + clazz.getName());
			return false;
		}
	...
	{
		this.channels = NetworkRegistry.INSTANCE.newChannel(TeloMod.MODID, this);
		registerPackets();
	}

	public void registerPackets ()
	{
		registerPacket(LeftMousePacket.class);
	}
